...
import com.example.bubblenew.FloatingBubbleConfig;
...
public class FloatingBubbleTouch implements View.OnTouchListener {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
                if (expandableView.getVisibility() == View.GONE) {
                    View rootView = expandableView.getRootView();
    ...
    private void getApiCall(View rootView) {
        final TextView itemName = rootView.findViewById(R.id.item_name);
        final TextView price = rootView.findViewById(R.id.price);
        final TextView sku = rootView.findViewById(R.id.sku);
        final TextView brand = rootView.findViewById(R.id.brand);
